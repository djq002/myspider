...
for joburl in my.mvalue:
   ...
   judge = re.match(r".*(hr|Hr|career|Career|job|Job|joinus|Joinus|join|Join|recruit|Recruit|zhaopin|ZhaoPin|zpxx|ZPXX|employer|Employer|campus|Campus|school|School).*",joburl)
